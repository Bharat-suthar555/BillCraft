      ...
      <div className="flex h-14 items-center border-b border-sidebar-border px-4">
        ...
        {!collapsed && (
          <div className="ml-3 overflow-hidden">
            <div className="gradient-text text-sm font-bold leading-none">InvoiceGen</div>
            <div className="mt-0.5 text-xs text-muted-foreground leading-none">PDF Generator</div>
          </div>
        )}
      </div>
            ...
            >
              ...
              {!collapsed && (
                <div className="overflow-hidden">
                  <div className="truncate font-medium leading-none">{label}</div>
...
export function MobileBottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 flex border-t border-border bg-card sm:hidden">
      {NAV.map(({ href, icon: Icon, label, exact }) => {
        ...
        return (
          <Link
            ...
            href={href}
            className={cn(
              'flex flex-1 flex-col items-center justify-center py-2.5 text-xs gap-1 transition-colors',
